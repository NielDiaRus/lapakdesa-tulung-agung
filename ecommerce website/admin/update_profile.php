...
<head>
   ...
   <title>Perbarui Profil Akun</title>
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>perbarui profil akun</h3>
      <input type="hidden" name="prev_pass" value="<?= $fetch_profile['password']; ?>">
      <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" required placeholder="masukkan username anda" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
