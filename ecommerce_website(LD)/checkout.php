   ...
   <h3>Pesanan anda</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" name="number" placeholder="masukkan no telpon anda" class="box" min="0" max="9999999999" onkeypress="if(this.value.length == 10) return false;" required>
         </div>
         <div class="inputBox">
            <span>email :</span>
         ...
         <div class="inputBox">
            ...
            <select name="method" class="box" required>
               ...
               <option value="credit card">transfer no rekening</option>
               
            </select>
         </div>
         <div class="inputBox">
            <span>alamat :</span>
            <input type="text" name="flat" placeholder="alamat" class="box" maxlength="50" required>
         </div>
